...
- **docs/**: Markdown documentation (tracked in git)
- **docfiles/**: Sphinx RST source files (tracked in git)
- **docfiles/AUTOGEN_results/**: Auto-generated API docs (not tracked, generated by sphinx-apidoc)
- **docfiles/_build/**: Sphinx build output (not tracked, generated by make html)
- **docs/*.html, docs/**/*.html**: Built HTML for GitHub Pages (not tracked after October 2025 cleanup)
