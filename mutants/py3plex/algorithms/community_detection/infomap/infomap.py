...
class Infomap(_object):
    ...
    if _newclass:
        config = _swig_property(
            _infomap.Infomap_config_get, _infomap.Infomap_config_set
        )
    __swig_setmethods__["network"] = _infomap.Infomap_network_set
    __swig_getmethods__["network"] = _infomap.Infomap_network_get
    if _newclass:
        network = _swig_property(
            _infomap.Infomap_network_get, _infomap.Infomap_network_set
        )
...
class MemInfomap(_object):
    ...
    def addStateLink(self, n1PriorState, n1, n2PriorState, n2, weight=1.0):
        return _infomap.MemInfomap_addStateLink(
            self, n1PriorState, n1, n2PriorState, n2, weight
        )

    def addMultiplexLink(self, layer1, node1, layer2, node2, weight=1.0):
        return _infomap.MemInfomap_addMultiplexLink(
            self, layer1, node1, layer2, node2, weight
        )
...
class Config(_object):
    ...
    if _newclass:
        parsedArgs = _swig_property(
            _infomap.Config_parsedArgs_get, _infomap.Config_parsedArgs_set
        )
    ...
    if _newclass:
        networkFile = _swig_property(
            _infomap.Config_networkFile_get, _infomap.Config_networkFile_set
        )
    ...
    if _newclass:
        additionalInput = _swig_property(
            _infomap.Config_additionalInput_get, _infomap.Config_additionalInput_set
        )
    ...
    if _newclass:
        inputFormat = _swig_property(
            _infomap.Config_inputFormat_get, _infomap.Config_inputFormat_set
        )
    ...
    if _newclass:
        withMemory = _swig_property(
            _infomap.Config_withMemory_get, _infomap.Config_withMemory_set
        )
    __swig_setmethods__["bipartite"] = _infomap.Config_bipartite_set
    __swig_getmethods__["bipartite"] = _infomap.Config_bipartite_get
    if _newclass:
        bipartite = _swig_property(
            _infomap.Config_bipartite_get, _infomap.Config_bipartite_set
        )
    __swig_setmethods__["skipAdjustBipartiteFlow"] = (
        _infomap.Config_skipAdjustBipartiteFlow_set
    )
    __swig_getmethods__["skipAdjustBipartiteFlow"] = (
    ...
    __swig_setmethods__["multiplexAddMissingNodes"] = (
        _infomap.Config_multiplexAddMissingNodes_set
    )
    __swig_getmethods__["multiplexAddMissingNodes"] = (
    ...
    if _newclass:
        hardPartitions = _swig_property(
            _infomap.Config_hardPartitions_get, _infomap.Config_hardPartitions_set
        )
    ...
    if _newclass:
        nonBacktracking = _swig_property(
            _infomap.Config_nonBacktracking_get, _infomap.Config_nonBacktracking_set
        )
    __swig_setmethods__["parseWithoutIOStreams"] = (
        _infomap.Config_parseWithoutIOStreams_set
    )
    __swig_getmethods__["parseWithoutIOStreams"] = (
    ...
    __swig_setmethods__["zeroBasedNodeNumbers"] = (
        _infomap.Config_zeroBasedNodeNumbers_set
    )
    __swig_getmethods__["zeroBasedNodeNumbers"] = (
    ...
    if _newclass:
        includeSelfLinks = _swig_property(
            _infomap.Config_includeSelfLinks_get, _infomap.Config_includeSelfLinks_set
        )
    ...
    if _newclass:
        ignoreEdgeWeights = _swig_property(
            _infomap.Config_ignoreEdgeWeights_get, _infomap.Config_ignoreEdgeWeights_set
        )
    __swig_setmethods__["completeDanglingMemoryNodes"] = (
        _infomap.Config_completeDanglingMemoryNodes_set
    )
    __swig_getmethods__["completeDanglingMemoryNodes"] = (
    ...
    if _newclass:
        nodeLimit = _swig_property(
            _infomap.Config_nodeLimit_get, _infomap.Config_nodeLimit_set
        )
    ...
    if _newclass:
        weightThreshold = _swig_property(
            _infomap.Config_weightThreshold_get, _infomap.Config_weightThreshold_set
        )
    ...
    __swig_setmethods__["recordedTeleportation"] = (
        _infomap.Config_recordedTeleportation_set
    )
    __swig_getmethods__["recordedTeleportation"] = (
    ...
    if _newclass:
        teleportToNodes = _swig_property(
            _infomap.Config_teleportToNodes_get, _infomap.Config_teleportToNodes_set
        )
    __swig_setmethods__["teleportationProbability"] = (
        _infomap.Config_teleportationProbability_set
    )
    __swig_getmethods__["teleportationProbability"] = (
    ...
    __swig_setmethods__["selfTeleportationProbability"] = (
        _infomap.Config_selfTeleportationProbability_set
    )
    __swig_getmethods__["selfTeleportationProbability"] = (
    ...
    if _newclass:
        markovTime = _swig_property(
            _infomap.Config_markovTime_get, _infomap.Config_markovTime_set
        )
    ...
    __swig_setmethods__["preferredNumberOfModules"] = (
        _infomap.Config_preferredNumberOfModules_set
    )
    __swig_getmethods__["preferredNumberOfModules"] = (
    ...
    __swig_setmethods__["multiplexJSRelaxRate"] = (
        _infomap.Config_multiplexJSRelaxRate_set
    )
    __swig_getmethods__["multiplexJSRelaxRate"] = (
    ...
    __swig_setmethods__["multiplexJSRelaxLimit"] = (
        _infomap.Config_multiplexJSRelaxLimit_set
    )
    __swig_getmethods__["multiplexJSRelaxLimit"] = (
    ...
    __swig_setmethods__["seedToRandomNumberGenerator"] = (
        _infomap.Config_seedToRandomNumberGenerator_set
    )
    __swig_getmethods__["seedToRandomNumberGenerator"] = (
    ...
    if _newclass:
        numTrials = _swig_property(
            _infomap.Config_numTrials_get, _infomap.Config_numTrials_set
        )
    __swig_setmethods__["minimumCodelengthImprovement"] = (
        _infomap.Config_minimumCodelengthImprovement_set
    )
    __swig_getmethods__["minimumCodelengthImprovement"] = (
    ...
    __swig_setmethods__["minimumSingleNodeCodelengthImprovement"] = (
        _infomap.Config_minimumSingleNodeCodelengthImprovement_set
    )
    __swig_getmethods__["minimumSingleNodeCodelengthImprovement"] = (
    ...
    __swig_setmethods__["randomizeCoreLoopLimit"] = (
        _infomap.Config_randomizeCoreLoopLimit_set
    )
    __swig_getmethods__["randomizeCoreLoopLimit"] = (
    ...
    if _newclass:
        coreLoopLimit = _swig_property(
            _infomap.Config_coreLoopLimit_get, _infomap.Config_coreLoopLimit_set
        )
    __swig_setmethods__["levelAggregationLimit"] = (
        _infomap.Config_levelAggregationLimit_set
    )
    __swig_getmethods__["levelAggregationLimit"] = (
    ...
    __swig_setmethods__["minimumRelativeTuneIterationImprovement"] = (
        _infomap.Config_minimumRelativeTuneIterationImprovement_set
    )
    __swig_getmethods__["minimumRelativeTuneIterationImprovement"] = (
    ...
    __swig_setmethods__["fastCoarseTunePartition"] = (
        _infomap.Config_fastCoarseTunePartition_set
    )
    __swig_getmethods__["fastCoarseTunePartition"] = (
    ...
    __swig_setmethods__["alternateCoarseTuneLevel"] = (
        _infomap.Config_alternateCoarseTuneLevel_set
    )
    __swig_getmethods__["alternateCoarseTuneLevel"] = (
    ...
    if _newclass:
        coarseTuneLevel = _swig_property(
            _infomap.Config_coarseTuneLevel_get, _infomap.Config_coarseTuneLevel_set
        )
    __swig_setmethods__["fastHierarchicalSolution"] = (
        _infomap.Config_fastHierarchicalSolution_set
    )
    __swig_getmethods__["fastHierarchicalSolution"] = (
    ...
    if _newclass:
        lowMemoryPriority = _swig_property(
            _infomap.Config_lowMemoryPriority_get, _infomap.Config_lowMemoryPriority_set
        )
    __swig_setmethods__["innerParallelization"] = (
        _infomap.Config_innerParallelization_set
    )
    __swig_getmethods__["innerParallelization"] = (
    ...
    __swig_setmethods__["resetConfigBeforeRecursion"] = (
        _infomap.Config_resetConfigBeforeRecursion_set
    )
    __swig_getmethods__["resetConfigBeforeRecursion"] = (
    ...
    if _newclass:
        outDirectory = _swig_property(
            _infomap.Config_outDirectory_get, _infomap.Config_outDirectory_set
        )
    __swig_setmethods__["outName"] = _infomap.Config_outName_set
    __swig_getmethods__["outName"] = _infomap.Config_outName_get
    if _newclass:
        outName = _swig_property(
            _infomap.Config_outName_get, _infomap.Config_outName_set
        )
    __swig_setmethods__["originallyUndirected"] = (
        _infomap.Config_originallyUndirected_set
    )
    __swig_getmethods__["originallyUndirected"] = (
    ...
    if _newclass:
        printTree = _swig_property(
            _infomap.Config_printTree_get, _infomap.Config_printTree_set
        )
    ...
    if _newclass:
        printFlowTree = _swig_property(
            _infomap.Config_printFlowTree_get, _infomap.Config_printFlowTree_set
        )
    __swig_setmethods__["printMap"] = _infomap.Config_printMap_set
    __swig_getmethods__["printMap"] = _infomap.Config_printMap_get
    if _newclass:
        printMap = _swig_property(
            _infomap.Config_printMap_get, _infomap.Config_printMap_set
        )
    __swig_setmethods__["printClu"] = _infomap.Config_printClu_set
    __swig_getmethods__["printClu"] = _infomap.Config_printClu_get
    if _newclass:
        printClu = _swig_property(
            _infomap.Config_printClu_get, _infomap.Config_printClu_set
        )
    ...
    if _newclass:
        printNodeRanks = _swig_property(
            _infomap.Config_printNodeRanks_get, _infomap.Config_printNodeRanks_set
        )
    ...
    if _newclass:
        printFlowNetwork = _swig_property(
            _infomap.Config_printFlowNetwork_get, _infomap.Config_printFlowNetwork_set
        )
    ...
    if _newclass:
        printPajekNetwork = _swig_property(
            _infomap.Config_printPajekNetwork_get, _infomap.Config_printPajekNetwork_set
        )
    ...
    if _newclass:
        printStateNetwork = _swig_property(
            _infomap.Config_printStateNetwork_get, _infomap.Config_printStateNetwork_set
        )
    ...
    if _newclass:
        printBinaryTree = _swig_property(
            _infomap.Config_printBinaryTree_get, _infomap.Config_printBinaryTree_set
        )
    ...
    if _newclass:
        printExpanded = _swig_property(
            _infomap.Config_printExpanded_get, _infomap.Config_printExpanded_set
        )
    ...
    if _newclass:
        printAllTrials = _swig_property(
            _infomap.Config_printAllTrials_get, _infomap.Config_printAllTrials_set
        )
    ...
    if _newclass:
        noFileOutput = _swig_property(
            _infomap.Config_noFileOutput_get, _infomap.Config_noFileOutput_set
        )
    __swig_setmethods__["verbosity"] = _infomap.Config_verbosity_set
    __swig_getmethods__["verbosity"] = _infomap.Config_verbosity_get
    if _newclass:
        verbosity = _swig_property(
            _infomap.Config_verbosity_get, _infomap.Config_verbosity_set
        )
    __swig_setmethods__["verboseNumberPrecision"] = (
        _infomap.Config_verboseNumberPrecision_set
    )
    __swig_getmethods__["verboseNumberPrecision"] = (
    ...
    if _newclass:
        benchmark = _swig_property(
            _infomap.Config_benchmark_get, _infomap.Config_benchmark_set
        )
    ...
    if _newclass:
        showBiNodes = _swig_property(
            _infomap.Config_showBiNodes_get, _infomap.Config_showBiNodes_set
        )
    ...
    __swig_setmethods__["minBipartiteNodeIndex"] = (
        _infomap.Config_minBipartiteNodeIndex_set
    )
    __swig_getmethods__["minBipartiteNodeIndex"] = (
    ...
    if _newclass:
        startDate = _swig_property(
            _infomap.Config_startDate_get, _infomap.Config_startDate_set
        )
    ...
    if _newclass:
        version = _swig_property(
            _infomap.Config_version_get, _infomap.Config_version_set
        )
...
class BipartiteLink(_object):
    ...
    if _newclass:
        node = _swig_property(
            _infomap.BipartiteLink_node_get, _infomap.BipartiteLink_node_set
        )
    ...
    if _newclass:
        swapOrder = _swig_property(
            _infomap.BipartiteLink_swapOrder_get, _infomap.BipartiteLink_swapOrder_set
        )
...
class ComplementaryData(_object):
    ...
    __swig_setmethods__["incompleteLink"] = (
        _infomap.ComplementaryData_incompleteLink_set
    )
    __swig_getmethods__["incompleteLink"] = (
    ...
    if _newclass:
        exactMatch = _swig_property(
            _infomap.ComplementaryData_exactMatch_get,
            _infomap.ComplementaryData_exactMatch_set,
        )
    __swig_setmethods__["sumWeightExactMatch"] = (
        _infomap.ComplementaryData_sumWeightExactMatch_set
    )
    __swig_getmethods__["sumWeightExactMatch"] = (
    ...
    __swig_setmethods__["sumWeightPartialMatch"] = (
        _infomap.ComplementaryData_sumWeightPartialMatch_set
    )
    __swig_getmethods__["sumWeightPartialMatch"] = (
    ...
    __swig_setmethods__["sumWeightShiftedMatch"] = (
        _infomap.ComplementaryData_sumWeightShiftedMatch_set
    )
    __swig_getmethods__["sumWeightShiftedMatch"] = (
...
class NodeData(_object):
    ...
    if _newclass:
        enterFlow = _swig_property(
            _infomap.NodeData_enterFlow_get, _infomap.NodeData_enterFlow_set
        )
    __swig_setmethods__["exitFlow"] = _infomap.NodeData_exitFlow_set
    __swig_getmethods__["exitFlow"] = _infomap.NodeData_exitFlow_get
    if _newclass:
        exitFlow = _swig_property(
            _infomap.NodeData_exitFlow_get, _infomap.NodeData_exitFlow_set
        )
    ...
    if _newclass:
        teleportRate = _swig_property(
            _infomap.NodeData_teleportRate_get, _infomap.NodeData_teleportRate_set
        )
    ...
    if _newclass:
        danglingFlow = _swig_property(
            _infomap.NodeData_danglingFlow_get, _infomap.NodeData_danglingFlow_set
        )
    ...
    if _newclass:
        indexCodelength = _swig_property(
            _infomap.NodeData_indexCodelength_get, _infomap.NodeData_indexCodelength_set
        )
...
class ChildEdge(_object):
    ...
    if _newclass:
        source = _swig_property(
            _infomap.ChildEdge_source_get, _infomap.ChildEdge_source_set
        )
    __swig_setmethods__["target"] = _infomap.ChildEdge_target_set
    __swig_getmethods__["target"] = _infomap.ChildEdge_target_get
    if _newclass:
        target = _swig_property(
            _infomap.ChildEdge_target_get, _infomap.ChildEdge_target_set
        )
...
class SNode(_object):
    ...
    if _newclass:
        depthBelow = _swig_property(
            _infomap.SNode_depthBelow_get, _infomap.SNode_depthBelow_set
        )
    __swig_setmethods__["parentNode"] = _infomap.SNode_parentNode_set
    __swig_getmethods__["parentNode"] = _infomap.SNode_parentNode_get
    if _newclass:
        parentNode = _swig_property(
            _infomap.SNode_parentNode_get, _infomap.SNode_parentNode_set
        )
    ...
    if _newclass:
        parentIndex = _swig_property(
            _infomap.SNode_parentIndex_get, _infomap.SNode_parentIndex_set
        )
    ...
    if _newclass:
        originalLeafIndex = _swig_property(
            _infomap.SNode_originalLeafIndex_get, _infomap.SNode_originalLeafIndex_set
        )
    ...
    if _newclass:
        children = _swig_property(
            _infomap.SNode_children_get, _infomap.SNode_children_set
        )
    __swig_setmethods__["childEdges"] = _infomap.SNode_childEdges_set
    __swig_getmethods__["childEdges"] = _infomap.SNode_childEdges_get
    if _newclass:
        childEdges = _swig_property(
            _infomap.SNode_childEdges_get, _infomap.SNode_childEdges_set
        )
    ...
    if _newclass:
        isMemoryNode = _swig_property(
            _infomap.SNode_isMemoryNode_get, _infomap.SNode_isMemoryNode_set
        )
    __swig_setmethods__["stateIndex"] = _infomap.SNode_stateIndex_set
    __swig_getmethods__["stateIndex"] = _infomap.SNode_stateIndex_get
    if _newclass:
        stateIndex = _swig_property(
            _infomap.SNode_stateIndex_get, _infomap.SNode_stateIndex_set
        )
    __swig_setmethods__["physIndex"] = _infomap.SNode_physIndex_set
    __swig_getmethods__["physIndex"] = _infomap.SNode_physIndex_get
    if _newclass:
        physIndex = _swig_property(
            _infomap.SNode_physIndex_get, _infomap.SNode_physIndex_set
        )
    ...
    def createChildEdge(self, sourceIndex, targetIndex, flow, directed):
        return _infomap.SNode_createChildEdge(
            self, sourceIndex, targetIndex, flow, directed
        )
...
class LeafIterator(_object):
    ...
    if _newclass:
        data = _swig_property(
            _infomap.LeafIterator_data_get, _infomap.LeafIterator_data_set
        )
    ...
    if _newclass:
        depthBelow = _swig_property(
            _infomap.LeafIterator_depthBelow_get, _infomap.LeafIterator_depthBelow_set
        )
    ...
    if _newclass:
        parentNode = _swig_property(
            _infomap.LeafIterator_parentNode_get, _infomap.LeafIterator_parentNode_set
        )
    ...
    if _newclass:
        parentIndex = _swig_property(
            _infomap.LeafIterator_parentIndex_get, _infomap.LeafIterator_parentIndex_set
        )
    __swig_setmethods__["isLeaf"] = _infomap.LeafIterator_isLeaf_set
    __swig_getmethods__["isLeaf"] = _infomap.LeafIterator_isLeaf_get
    if _newclass:
        isLeaf = _swig_property(
            _infomap.LeafIterator_isLeaf_get, _infomap.LeafIterator_isLeaf_set
        )
    __swig_setmethods__["originalLeafIndex"] = (
        _infomap.LeafIterator_originalLeafIndex_set
    )
    __swig_getmethods__["originalLeafIndex"] = (
    ...
    if _newclass:
        children = _swig_property(
            _infomap.LeafIterator_children_get, _infomap.LeafIterator_children_set
        )
    ...
    if _newclass:
        childEdges = _swig_property(
            _infomap.LeafIterator_childEdges_get, _infomap.LeafIterator_childEdges_set
        )
    __swig_setmethods__["skip"] = _infomap.LeafIterator_skip_set
    __swig_getmethods__["skip"] = _infomap.LeafIterator_skip_get
    if _newclass:
        skip = _swig_property(
            _infomap.LeafIterator_skip_get, _infomap.LeafIterator_skip_set
        )
    ...
    if _newclass:
        isMemoryNode = _swig_property(
            _infomap.LeafIterator_isMemoryNode_get,
    ...
    if _newclass:
        stateIndex = _swig_property(
            _infomap.LeafIterator_stateIndex_get, _infomap.LeafIterator_stateIndex_set
        )
    ...
    if _newclass:
        physIndex = _swig_property(
            _infomap.LeafIterator_physIndex_get, _infomap.LeafIterator_physIndex_set
        )
    ...
    def createChildEdge(self, sourceIndex, targetIndex, flow, directed):
        return _infomap.LeafIterator_createChildEdge(
            self, sourceIndex, targetIndex, flow, directed
        )
...
class TreeIterator(_object):
    ...
    if _newclass:
        data = _swig_property(
            _infomap.TreeIterator_data_get, _infomap.TreeIterator_data_set
        )
    ...
    if _newclass:
        depthBelow = _swig_property(
            _infomap.TreeIterator_depthBelow_get, _infomap.TreeIterator_depthBelow_set
        )
    ...
    if _newclass:
        parentNode = _swig_property(
            _infomap.TreeIterator_parentNode_get, _infomap.TreeIterator_parentNode_set
        )
    ...
    if _newclass:
        parentIndex = _swig_property(
            _infomap.TreeIterator_parentIndex_get, _infomap.TreeIterator_parentIndex_set
        )
    __swig_setmethods__["isLeaf"] = _infomap.TreeIterator_isLeaf_set
    __swig_getmethods__["isLeaf"] = _infomap.TreeIterator_isLeaf_get
    if _newclass:
        isLeaf = _swig_property(
            _infomap.TreeIterator_isLeaf_get, _infomap.TreeIterator_isLeaf_set
        )
    __swig_setmethods__["originalLeafIndex"] = (
    ...
    if _newclass:
        children = _swig_property(
            _infomap.TreeIterator_children_get, _infomap.TreeIterator_children_set
        )
    ...
    if _newclass:
        childEdges = _swig_property(
            _infomap.TreeIterator_childEdges_get, _infomap.TreeIterator_childEdges_set
        )
    __swig_setmethods__["skip"] = _infomap.TreeIterator_skip_set
    __swig_getmethods__["skip"] = _infomap.TreeIterator_skip_get
    if _newclass:
        skip = _swig_property(
            _infomap.TreeIterator_skip_get, _infomap.TreeIterator_skip_set
        )
    ...
    if _newclass:
        isMemoryNode = _swig_property(
            _infomap.TreeIterator_isMemoryNode_get,
    ...
    if _newclass:
        stateIndex = _swig_property(
            _infomap.TreeIterator_stateIndex_get, _infomap.TreeIterator_stateIndex_set
        )
    ...
    if _newclass:
        physIndex = _swig_property(
            _infomap.TreeIterator_physIndex_get, _infomap.TreeIterator_physIndex_set
        )
    ...
    def createChildEdge(self, sourceIndex, targetIndex, flow, directed):
        return _infomap.TreeIterator_createChildEdge(
            self, sourceIndex, targetIndex, flow, directed
        )
...
class ChildIterator(_object):
    ...
    if _newclass:
        data = _swig_property(
            _infomap.ChildIterator_data_get, _infomap.ChildIterator_data_set
        )
    __swig_setmethods__["depth"] = _infomap.ChildIterator_depth_set
    __swig_getmethods__["depth"] = _infomap.ChildIterator_depth_get
    if _newclass:
        depth = _swig_property(
            _infomap.ChildIterator_depth_get, _infomap.ChildIterator_depth_set
        )
    ...
    if _newclass:
        depthBelow = _swig_property(
            _infomap.ChildIterator_depthBelow_get, _infomap.ChildIterator_depthBelow_set
        )
    ...
    if _newclass:
        parentNode = _swig_property(
            _infomap.ChildIterator_parentNode_get, _infomap.ChildIterator_parentNode_set
        )
    ...
    if _newclass:
        parentIndex = _swig_property(
            _infomap.ChildIterator_parentIndex_get,
    ...
    if _newclass:
        isLeaf = _swig_property(
            _infomap.ChildIterator_isLeaf_get, _infomap.ChildIterator_isLeaf_set
        )
    __swig_setmethods__["originalLeafIndex"] = (
    ...
    if _newclass:
        id = _swig_property(
            _infomap.ChildIterator_id_get, _infomap.ChildIterator_id_set
        )
    ...
    if _newclass:
        children = _swig_property(
            _infomap.ChildIterator_children_get, _infomap.ChildIterator_children_set
        )
    ...
    if _newclass:
        childEdges = _swig_property(
            _infomap.ChildIterator_childEdges_get, _infomap.ChildIterator_childEdges_set
        )
    __swig_setmethods__["skip"] = _infomap.ChildIterator_skip_set
    __swig_getmethods__["skip"] = _infomap.ChildIterator_skip_get
    if _newclass:
        skip = _swig_property(
            _infomap.ChildIterator_skip_get, _infomap.ChildIterator_skip_set
        )
    ...
    if _newclass:
        isMemoryNode = _swig_property(
            _infomap.ChildIterator_isMemoryNode_get,
    ...
    if _newclass:
        stateIndex = _swig_property(
            _infomap.ChildIterator_stateIndex_get, _infomap.ChildIterator_stateIndex_set
        )
    ...
    if _newclass:
        physIndex = _swig_property(
            _infomap.ChildIterator_physIndex_get, _infomap.ChildIterator_physIndex_set
        )
    ...
    def serialize(self, outFile, childPosition, writeEdges):
        return _infomap.ChildIterator_serialize(
            self, outFile, childPosition, writeEdges
        )
    ...
    def createChildEdge(self, sourceIndex, targetIndex, flow, directed):
        return _infomap.ChildIterator_createChildEdge(
            self, sourceIndex, targetIndex, flow, directed
        )
...
class HierarchicalNetwork(_object):
    ...
    def init(self, networkName, codelength, oneLevelCodelength):
        return _infomap.HierarchicalNetwork_init(
            self, networkName, codelength, oneLevelCodelength
        )
