...
import hedwig
from hedwig.core.settings import DESCRIPTION, INPUT_FORMATS, VERSION, Defaults
from hedwig.stats import adjustment, scorefunctions
...
parser.add_argument(
    "-s", "--score", choices=functions, default=Defaults.SCORE, help="Score function."
)
...
parser.add_argument(
    "-lx", "--latex_report", action="store_true", help="Report as latex strings"
)
...
parser.add_argument(
    "-u", "--uris", action="store_true", help="Show URIs in rule conjunctions."
)

parser.add_argument(
    "-b", "--beam", default=Defaults.BEAM_SIZE, type=int, help="Beam size."
)

parser.add_argument(
    "-S", "--support", default=Defaults.SUPPORT, type=float, help="Minimum support."
)
