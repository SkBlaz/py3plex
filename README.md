...
![Lines of Code](https://img.shields.io/badge/lines-171K-blue)
...
| **Multilayer network theory** | Theory / methodology | Formal foundations of multilayer, multiplex, interconnected, and temporal networks | Provides the conceptual basis for node-layer structures, interlayer coupling, temporal networks, multilayer measures, diffusion, and dynamics | **Conceptual foundation, not software competition.** py3plex 2.0 operationalizes these ideas as Python workflows, DSL queries, temporal windows, uncertainty-aware summaries, and executable analyses. |
