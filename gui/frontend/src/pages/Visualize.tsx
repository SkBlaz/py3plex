    ...
    <div className="px-4 py-6">
      ...
      <div className="grid grid-cols-4 gap-6">
        ...
        <div className="col-span-1 bg-white dark:bg-gray-800 shadow rounded-lg p-4">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">Layer controls will appear here</p>
        </div>
        ...
        <div className="col-span-2 bg-white dark:bg-gray-800 shadow rounded-lg p-4">
          ...
          {positions && !loading && (
            <div className="h-96 bg-gray-50 dark:bg-gray-700 rounded border border-gray-200 dark:border-gray-600 flex items-center justify-center">
              <div className="text-center">
