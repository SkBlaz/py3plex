...
@st.composite
def simple_graphs(draw, directed=None, min_nodes=0, max_nodes=10):
    ...
    # Generate edges (ensure valid endpoints)
    if n_nodes >= 2:
        n_edges = draw(st.integers(min_value=0, max_value=min(15, n_nodes * (n_nodes - 1))))
...
class TestNetworkXRoundtripProperties:
    ...
    @settings(max_examples=20, deadline=5000, suppress_health_check=[HealthCheck.too_slow])
    @given(graph=simple_graphs(min_nodes=2, max_nodes=8))
    ...
    @settings(max_examples=20, deadline=5000, suppress_health_check=[HealthCheck.too_slow])
    @given(graph=simple_graphs(directed=False, min_nodes=2, max_nodes=8))
    ...
    @given(graph=simple_graphs(directed=True, min_nodes=2, max_nodes=8))
...
class TestIRProperties:
    ...
    @given(graph=simple_graphs(min_nodes=1, max_nodes=10))
    ...
    @settings(max_examples=20, deadline=3000, suppress_health_check=[HealthCheck.too_slow])
    @given(graph=simple_graphs(min_nodes=2, max_nodes=10))
...
class TestConversionInvariants:
    ...
    @settings(max_examples=20, deadline=3000, suppress_health_check=[HealthCheck.too_slow])
    @given(graph=simple_graphs(min_nodes=1, max_nodes=8))
