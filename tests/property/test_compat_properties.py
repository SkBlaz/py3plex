...
class TestNetworkXRoundtripProperties:
    ...
    @settings(max_examples=3, deadline=5000, suppress_health_check=[HealthCheck.too_slow, HealthCheck.large_base_example])
...
class TestIRProperties:
    ...
    @settings(max_examples=3, deadline=3000, suppress_health_check=[HealthCheck.too_slow, HealthCheck.large_base_example])
    @given(graph=simple_graphs(min_nodes=1, max_nodes=5))
