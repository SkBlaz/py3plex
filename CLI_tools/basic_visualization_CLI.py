...
def visualize_network(input_file, input_type, directed, visualization_type):
    multilayer_network = multinet.multi_layer_network().load_network(input_file,directed=directed, input_type=input_type)
    multilayer_network.basic_stats() ## check core imports
    multilayer_network.visualize_network(style=visualization_type) ## visualize
    plt.show()
...
if __name__ == "__main__":
    ...
    visualize_network(args.network_file,args.network_type,args.directed,args.visualization_type)
