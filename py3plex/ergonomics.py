...
def quick_analysis(
    ...
    return {
        ...
        'network_stats': {
            ...
            'layers': len(list(network.get_layers()))
        }
    }
...
def quick_communities(
    ...
    if algorithm == 'louvain':
        ...
        raise ValueError(f"Unknown algorithm: {algorithm}. Use 'louvain' or 'leiden'")
...
def show_network_summary(network: Any) -> None:
    ...
    print(f"  • Physical nodes: {len(set(n[0] for n in nodes))}")
