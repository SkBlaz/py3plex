...
Available datasets:
    - load_aarhus_cs: Load the Aarhus CS department social network (small)
    - load_synthetic_multilayer: Load a synthetic multilayer network

Synthetic generators:
    - make_random_multilayer: Generate random multilayer Erdős-Rényi network
    - make_random_multiplex: Generate random multiplex Erdős-Rényi network
    - make_clique_multiplex: Generate multiplex network with clique structure
    - make_social_network: Generate a synthetic social network

Utility functions:
    - list_datasets: List all available datasets
    - get_data_dir: Get the path to the data directory
