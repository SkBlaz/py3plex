...
def build_supra_modularity_matrix(
    ...
    layer_stats = {}
    for layer in layers:
        layer_nodes = [(i, nl) for i, nl in enumerate(node_layer_list) if nl[1] == layer]
...
def louvain_multilayer(
    ...
    while improved and iteration < max_iter:
        ...
        for idx in order:
            ...
            current_Q = multilayer_modularity(network, communities, gamma, omega, weight)
            ...
            for test_com in neighbor_communities:
                ...
                test_Q = multilayer_modularity(network, communities, gamma, omega, weight)
