...
def find_counterexample(
    ...
    t0 = time.time()
    witness = build_witness(network, violation, initial_radius, layers, budget.max_witness_size)
    ...
    provenance = _build_provenance(
        network, claim, seed, find_time, extract_time, minimize_time, total_time,
        minimization_report, budget
    )
