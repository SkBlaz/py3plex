...
- Removed redundant documentation file:
  - `COMPOSITIONAL_UQ_SUMMARY.md` - redundant implementation summary that duplicated information better placed in code documentation
...
- Aligned all documentation and book version references with library version
