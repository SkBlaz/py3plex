...
network = multinet.multi_layer_network().load_network("../datasets/intact02.gpickle",directed=False, input_type="gpickle")
...
hedwig_input_parameters = {"bk_dir": "../background_knowledge", "data": "../datasets/example_partition_inputs.n3", "format": "n3", "output": None, "covered": None, "mode": "subgroups", "target": None, "score": "lift", "negations": True, "alpha": 0.05, "latex_report": False, "adjust": "fwer", "FDR": 0.05, "leaves": True, "learner": "heuristic", "optimalsubclass": False, "uris": False, "beam": 300, "support": 0.01, "depth": 8, "nocache": False, "verbose": False,"adjust":"none"}
