...
- How coupling (ω) and resolution (γ) affect multilayer community structure
...
def example_random_er() -> None:
    """Example 2: Random multilayer Erdős-Rényi graph."""
    _print_header("Example 2: Random multilayer Erdős-Rényi network")
