...
This script showcases 24 multilayer network statistics implemented
...
try:
    ...
    # 19. Inter-layer Dependence Entropy
    ...
    # 20. Cross-layer Redundancy Entropy
    ...
    # 21. Cross-layer Mutual Information
    ...
    # 23. Multilayer Betweenness Surface
    ...
    # 24. Inter-layer Degree Correlation Matrix
    ...
    print("\n" + "=" * 70)
    print("All 24 multilayer statistics computed successfully!")
    print("=" * 70)
