...
def main():
    ...
    print("\n1. High alpha (alpha=0.9) - Layers mostly independent:")
    ...
    print("\n2. Medium alpha (alpha=0.5) - Balanced layer coupling:")
    ...
    print("\n3. Low alpha (alpha=0.2) - Strong interlayer coupling:")
    ...
    print("=" * 70)
    print("Detailed Analysis (alpha=0.5)")
    print("=" * 70)
    print()
