"""First-class uncertainty walkthrough for multilayer PageRank.

Shows how StatSeries exposes deterministic results, perturbation-based
uncertainty, context-managed defaults, serialization, and side-by-side
comparisons. Dependencies: py3plex (editable install or sys.path tweak
below) and numpy.
"""
...
def example_1_deterministic() -> None:
...
def example_2_uncertainty() -> None:
...
def example_3_context_manager() -> None:
