...
2. Erdos-Renyi model - Random graph with fixed edge probability
...
def demonstrate_erdos_renyi_model(net: multinet.multi_layer_network) -> None:
    """Demo: Erdos-Renyi model with fixed edge probability."""
    print("\n" + "=" * 70)
    print("2. Erdos-Renyi Model")
    print("=" * 70)
...
def main() -> int:
    ...
    print("  2. Erdos-Renyi model - Uniform random connections")
    ...
    print("  - Erdos-Renyi: Compare against uniform random baseline")
