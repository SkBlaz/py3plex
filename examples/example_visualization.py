...
def plot_intact_basic(num_it = 10):
    ...
    f = plt.figure()
    hairball_plot(graph,network_colors,legend=False,layout_parameters=layout_parameters)
    f.savefig("../example_images/intact_"+str(num_it)+"_BH_basic.png", bbox_inches='tight',dpi=300)
...
def plot_intact_BH(num_it = 10):
    ...
    f = plt.figure()
    hairball_plot(graph,network_colors,legend=False,layout_parameters=layout_parameters)
    f.savefig("../example_images/intact_"+str(num_it)+"_BH.png", bbox_inches='tight',dpi=300)
...
if __name__ == "__main__":
    ...
    for iterations in iteration_range:
        ...
        print("Mean time for BK {}, iterations: {}".format(np.mean(mean_times),iterations))
