...
## monotone coloring
draw_multilayer_default(graphs,display=False,background_shape="rectangle",labels=network_labels,layout_algorithm="force",networks_color="black",rectanglex=2,rectangley=2,background_color="default")
