...
## some random graph
ER_multilayer = random_generators.random_multilayer_ER(5000,15,0.05,directed=False)
...
for j in range(5):
    ...
    sns.distplot(layer_visit_sequence,bins=10, kde=True,label="Walker {}".format(j+1),hist_kws={ "linewidth": 3,"alpha": 0.2})
plt.xlabel("Layer")
