...
print("✓ Generated multilayer network with 50 nodes and 3 layers")
...
print(f"✓ Sparse supra-adjacency matrix shape: {sparse_matrix.shape}")
...
print(f"✓ Dense supra-adjacency matrix shape: {dense_matrix.shape}")
...
print(f"✓ Retrieved {len(some_nodes)} nodes and {len(some_edges)} edges")

# random node is accessed as follows
if some_nodes:
    print(f"✓ Sample node: {ER_multilayer[some_nodes[0]]}")
