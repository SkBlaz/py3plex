...
* :doc:`changelog` — Release history and version notes
* :doc:`roadmap` — Future development plans
* :doc:`contributing` — How to contribute to py3plex
* :doc:`benchmarking` — Performance characteristics and optimization
* :doc:`citing` — How to cite py3plex in publications
