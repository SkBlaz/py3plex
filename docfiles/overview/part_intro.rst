...
* :doc:`what_is_py3plex` — Key features and what makes py3plex unique
* :doc:`key_use_cases` — Typical domains and applications
* :doc:`multilayer_in_2min` — Quick conceptual introduction to multilayer networks
