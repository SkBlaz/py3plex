...
* :doc:`development_guide` — Environment setup, running tests, submitting changes
* :doc:`code_architecture` — How py3plex is organized internally (modules, data flow, extension points)
* :doc:`repo_layout` — Directory structure and where key files live
* :doc:`contributing` — Bug reports, code style, review process
