...
''',
    ...
    # Prevent "(continues on next page)" markers and wrap indicators in code blocks
    # verbatimhintsturnover=false: removes "(continues on next page)" markers
    # verbatimwrapslines=false: disables line wrapping (prevents ˓→ continuation markers)
